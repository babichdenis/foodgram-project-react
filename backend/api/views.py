...
class CustomUserViewSet(UserViewSet):
    ...
    def subscriptions(self, request):
        user_subscriptions = Subscribe.objects.filter(user=request.user)
        author_ids = user_subscriptions.values_list('author_id', flat=True)
        queryset = CustomUser.objects.filter(pk__in=author_ids)
    ...
    def subscribe(self, request, id):
        ...
        subscription_exists = Subscribe.objects.filter(
